            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="post" action="{{route('admin.post.edit',['locale'=>$locale,'postid'=>$postEdit->id])}}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="type">
                                            <option @if($postEdit->type == 'post') selected="selected" @endif value="post">პოსტი</option>
                                            <option @if($postEdit->type == 'galerea') selected="selected" @endif value="galerea">გალერეა</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
