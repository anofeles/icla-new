    ...
    @if(isset($post->title) && !empty($post->title))
        ...
        <div id="c608086" class="csc-default"><h1></h1>
            ...
            <p class="align-center"><span style="font-size: 16px;">
                    <a style="text-decoration: none;" @if(empty($post->title)) href="programme/index.html" @endif
                    title="Opens internal link in current window"
                        class="internal-link"><b>{{$post->title}}</b></a></span>
            </p>
            <p class="align-center">&nbsp;</p>
            <!--  Text: [end] -->
        </div>
        ...
        <div id="c573684" class="csc-default"><h1></h1>
            ...
            <div class="csc-textpic csc-textpic-intext-left csc-textpic-equalheight">
                ...
                <div class="csc-textpic-imagewrap csc-textpic-single-image">
                    <img src="{{asset('images/post/'.$post->img)}}" width="248"
{{--                        height="351"--}}
                         border="0" alt=""/>
                </div>
                @endif
                <div class="csc-textpic-text">
                    <!--  Text: [begin] -->
                @if(!empty($post->text) && $post->text != null)
                    {!! $post->text !!}
                @else
                    {!! $post->desc !!}
                @endif
